...
get_latest_posts() - принимает соединение с базой данных и количество постов n. Возвращает список n последних постов с их комментариями. Каждый элемент списка должен быть словарем с ключами: 'id', 'title', 'content', 'author_id', 'created_at', 'comments'. 'comments' - это список словарей с ключами: 'id', 'author_id', 'content', 'created_at'
